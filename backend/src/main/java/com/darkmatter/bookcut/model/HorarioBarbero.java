...
/**
 * Entidad JPA que define la disponibilidad horaria de un barbero.
 * Almacena los rangos de horas de trabajo por día de la semana para gestionar las reservas.
 */
@Entity
